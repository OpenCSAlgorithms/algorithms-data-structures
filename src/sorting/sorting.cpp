...
namespace sorting {
    ...
    // Explicit instantiation of insertionSort for required types
    template void insertionSort(std::vector<int>& arr);
    template void insertionSort(std::vector<double>& arr);
